...
func openTLSConnect(ctx context.Context, s parse.Spec, mode Mode, g *Global) (*Opened, error) {
	// Dual-stack like TCP-CONNECT; pf=ip4/ip6 still forces a family.
	return openTLSConnectNetwork(ctx, s, mode, g, connectNetworkForType(g, s, firstHost(s), "tcp"))
}

func openTLSConnectNetwork(ctx context.Context, s parse.Spec, _ Mode, g *Global, network string) (*Opened, error) {
...
func openTLSListen(ctx context.Context, s parse.Spec, mode Mode, g *Global) (*Opened, error) {
...
func openTLSListenNetwork(ctx context.Context, s parse.Spec, _ Mode, g *Global, network string) (*Opened, error) {
