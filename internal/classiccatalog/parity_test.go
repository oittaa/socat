...
func TestPlatformSpecificNamesStayRequiredOnTheirGOOS(t *testing.T) {
	tests := []struct {
		...
		{"res-nsaddr", "linux", ClassMustAdvertise},
		{"res-nsaddr", "darwin", ClassMustAdvertise},
		{"res-nsaddr", "windows", ClassMustAdvertise},
		{"dns", "linux", ClassMustAdvertise},
		{"dns", "darwin", ClassMustAdvertise},
		{"dns", "windows", ClassMustAdvertise},
		{"nameserver", "linux", ClassMustAdvertise},
		{"nameserver", "darwin", ClassMustAdvertise},
		{"nameserver", "windows", ClassMustAdvertise},
		...
		{"ip-recvdstaddr", "darwin", ClassMustAdvertise},
		{"ip-recvdstaddr", "linux", ClassMustAdvertise},
		{"recvdstaddr", "darwin", ClassMustAdvertise},
		{"recvif", "linux", ClassMustAdvertise},
		...
		{"so-detach-filter", "linux", ClassUnsupported},
		{"detachfilter", "linux", ClassUnsupported},
...
func TestImplementationBacklogOmitsExclusions(t *testing.T) {
	...
	if _, ok := linux["ip-recvdstaddr"]; ok {
		t.Fatal("linux backlog must not include implemented ip-recvdstaddr")
	}
