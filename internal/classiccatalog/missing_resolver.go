...
var expectedMissingResolver = map[string]Gap{
	...
	"res-nsaddr":     {Reason: "per-address nameserver (res-nsaddr)", Platforms: PlatUnix},
	"nsaddr":         {Reason: "alias of res-nsaddr", Platforms: PlatUnix},
	"nameserver":     {Reason: "alias of res-nsaddr", Platforms: PlatUnix},
	"dns":            {Reason: "alias of res-nsaddr", Platforms: PlatUnix},
