...
func init() {
	...
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTLS, Name: "OPENSSL-L", Syntax: "OPENSSL-L:<port>", Desc: "alias of TLS-L", Opener: openTLSListen, OptionCaps: xio.CapsTLSListen, Role: listen, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTLS, Name: "SSL", Syntax: "SSL:<host>:<port>", Desc: "alias of TLS", Opener: openTLSConnect, OptionCaps: xio.CapsTLSConnect, Role: connect, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTLS, Name: "SSL-CONNECT", Syntax: "SSL-CONNECT:<host>:<port>", Desc: "alias of TLS-CONNECT", Opener: openTLSConnect, OptionCaps: xio.CapsTLSConnect, Role: connect, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTLS, Name: "SSL-LISTEN", Syntax: "SSL-LISTEN:<port>", Desc: "alias of TLS-LISTEN", Opener: openTLSListen, OptionCaps: xio.CapsTLSListen, Role: listen, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTLS, Name: "SSL-L", Syntax: "SSL-L:<port>", Desc: "alias of TLS-L", Opener: openTLSListen, OptionCaps: xio.CapsTLSListen, Role: listen, Family: anyIP})
}
