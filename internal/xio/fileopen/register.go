...
func init() {
	...
	xio.RegisterAddress(xio.AddressDesc{Group: files, Name: "PIPE", Syntax: "PIPE[:<filename>]", Desc: "anonymous pipe or named FIFO", Opener: openPIPE, OptionCaps: xio.CapsPIPE})
	xio.RegisterAddress(xio.AddressDesc{Group: files, Name: "FIFO", Syntax: "FIFO[:<filename>]", Desc: "same as PIPE", Opener: openPIPE, OptionCaps: xio.CapsPIPE})
	xio.RegisterAddress(xio.AddressDesc{Group: files, Name: "ECHO", Syntax: "ECHO", Desc: "same as PIPE", Opener: openPIPE, OptionCaps: xio.CapsPIPE})
	xio.RegisterAddress(xio.AddressDesc{Group: files, Name: "OPEN", Syntax: "OPEN:<filename>", Desc: "open a file", Opener: openOPEN, OptionCaps: xio.CapsOpen})
	xio.RegisterAddress(xio.AddressDesc{Group: files, Name: "FILE", Syntax: "FILE:<filename>", Desc: "same as OPEN", Opener: openOPEN, OptionCaps: xio.CapsOpen})
	xio.RegisterAddress(xio.AddressDesc{Group: files, Name: "CREATE", Syntax: "CREATE:<filename>", Desc: "create or truncate a file", Opener: openCREATE, OptionCaps: xio.CapsCreate, Directions: xio.ModeWrite})
	xio.RegisterAddress(xio.AddressDesc{Group: files, Name: "CREAT", Syntax: "CREAT:<filename>", Desc: "same as CREATE", Opener: openCREATE, OptionCaps: xio.CapsCreate, Directions: xio.ModeWrite})
	xio.RegisterAddress(xio.AddressDesc{Group: files, Name: "GOPEN", Syntax: "GOPEN:<filename>", Desc: "open or create a file (or socket)", Opener: openGOPEN, OptionCaps: xio.CapsGOPEN})
