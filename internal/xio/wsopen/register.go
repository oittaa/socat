...
func init() {
	...
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupWebSocket, Name: "WSS", Syntax: "WSS:<host>:<port>", Desc: "WebSocket client over TLS", Opener: openWSSConnect, OptionCaps: xio.CapsTLSConnect, Kind: kind, Role: connect, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupWebSocket, Name: "WSS-CONNECT", Syntax: "WSS-CONNECT:<host>:<port>", Desc: "same as WSS", Opener: openWSSConnect, OptionCaps: xio.CapsTLSConnect, Kind: kind, Role: connect, Family: anyIP})
	...
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupWebSocket, Name: "WSS-LISTEN", Syntax: "WSS-LISTEN:<port>", Desc: "WebSocket server over TLS; requires cert=", Opener: openWSSListen, OptionCaps: xio.CapsTLSListen, Kind: kind, Role: listen, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupWebSocket, Name: "WSS-L", Syntax: "WSS-L:<port>", Desc: "same as WSS-LISTEN", Opener: openWSSListen, OptionCaps: xio.CapsTLSListen, Kind: kind, Role: listen, Family: anyIP})
}
