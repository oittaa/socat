...
func init() {
	...
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupUDP, Name: "UDP-DATAGRAM", Syntax: "UDP-DATAGRAM:<host>:<port>", Desc: "connected UDP datagram", Opener: openUDPDatagram, OptionCaps: xio.CapsUDPDatagram, Aliases: []string{"UDP-DGRAM"}})
	...
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupUnix, Name: "UNIX-DATAGRAM", Syntax: "UNIX-DATAGRAM:<filename>", Desc: "UNIX datagram", Enabled: unixDgramEnabled, Opener: openUnixDatagram, OptionCaps: xio.CapsUNIXConnect})
