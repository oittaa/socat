...
func init() {
	...
	// TCP
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP", Syntax: "TCP:<host>:<port>", Desc: "TCP client", Opener: openTCPConnect, OptionCaps: xio.CapsTCPConnect, Role: connect, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP-CONNECT", Syntax: "TCP-CONNECT:<host>:<port>", Desc: "same as TCP", Opener: openTCPConnect, OptionCaps: xio.CapsTCPConnect, Aliases: []string{"INET"}, Role: connect, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP4", Syntax: "TCP4:<host>:<port>", Desc: "IPv4 TCP client", Opener: openTCP4Connect, OptionCaps: xio.CapsTCP4Connect, Role: connect, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP4-CONNECT", Syntax: "TCP4-CONNECT:<host>:<port>", Desc: "same as TCP4", Opener: openTCP4Connect, OptionCaps: xio.CapsTCP4Connect, Aliases: []string{"INET4"}, Role: connect, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP6", Syntax: "TCP6:<host>:<port>", Desc: "IPv6 TCP client", Opener: openTCP6Connect, OptionCaps: xio.CapsTCP6Connect, Role: connect, Family: v6})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP6-CONNECT", Syntax: "TCP6-CONNECT:<host>:<port>", Desc: "same as TCP6", Opener: openTCP6Connect, OptionCaps: xio.CapsTCP6Connect, Aliases: []string{"INET6"}, Role: connect, Family: v6})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP-LISTEN", Syntax: "TCP-LISTEN:<port>", Desc: "TCP server", Opener: openTCPListen, OptionCaps: xio.CapsTCPListen, Aliases: []string{"INET-L", "INET-LISTEN"}, Role: listen, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP-L", Syntax: "TCP-L:<port>", Desc: "same as TCP-LISTEN", Opener: openTCPListen, OptionCaps: xio.CapsTCPListen, Role: listen, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP4-LISTEN", Syntax: "TCP4-LISTEN:<port>", Desc: "IPv4 TCP server", Opener: openTCP4Listen, OptionCaps: xio.CapsTCP4Listen, Aliases: []string{"INET4-L", "INET4-LISTEN"}, Role: listen, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP4-L", Syntax: "TCP4-L:<port>", Desc: "same as TCP4-LISTEN", Opener: openTCP4Listen, OptionCaps: xio.CapsTCP4Listen, Role: listen, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupTCP, Name: "TCP6-LISTEN", Syntax: "TCP6-LISTEN:<port>", Desc: "IPv6 TCP server", Opener: openTCP6Listen, OptionCaps: xio.CapsTCP6Listen, Aliases: []string{"INET6-L", "INET6-LISTEN"}, Role: listen, Family: v6})
	...
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP", Syntax: "IP:<host>:<protocol>", Desc: "raw IP send/receive", Enabled: rawIPEnabled, Opener: openIP, OptionCaps: xio.CapsIPSendto, Kind: kindRaw, Role: sendTo, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP4", Syntax: "IP4:<host>:<protocol>", Desc: "IPv4 raw IP", Enabled: rawIPEnabled, Opener: openIP4, OptionCaps: xio.CapsIP4Sendto, Kind: kindRaw, Role: sendTo, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP6", Syntax: "IP6:<host>:<protocol>", Desc: "IPv6 raw IP", Enabled: rawIPEnabled, Opener: openIP6, OptionCaps: xio.CapsIP6Sendto, Kind: kindRaw, Role: sendTo, Family: v6})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP-SENDTO", Syntax: "IP-SENDTO:<host>:<protocol>", Desc: "raw IP send to one peer", Enabled: rawIPEnabled, Opener: openIPSendto, OptionCaps: xio.CapsIPSendto, Aliases: []string{"IP-SEND"}, Kind: kindRaw, Role: sendTo, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP4-SENDTO", Syntax: "IP4-SENDTO:<host>:<protocol>", Desc: "IPv4 raw IP sendto", Enabled: rawIPEnabled, Opener: openIP4Sendto, OptionCaps: xio.CapsIP4Sendto, Aliases: []string{"IP4-SEND"}, Kind: kindRaw, Role: sendTo, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP6-SENDTO", Syntax: "IP6-SENDTO:<host>:<protocol>", Desc: "IPv6 raw IP sendto", Enabled: rawIPEnabled, Opener: openIP6Sendto, OptionCaps: xio.CapsIP6Sendto, Aliases: []string{"IP6-SEND"}, Kind: kindRaw, Role: sendTo, Family: v6})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP-DATAGRAM", Syntax: "IP-DATAGRAM:<host>:<protocol>", Desc: "raw IP datagram", Enabled: rawIPEnabled, Opener: openIPDatagram, OptionCaps: xio.CapsIPDatagram, Aliases: []string{"IP-DGRAM"}, Kind: kindRaw, Role: dgram, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP4-DATAGRAM", Syntax: "IP4-DATAGRAM:<host>:<protocol>", Desc: "IPv4 raw IP datagram", Enabled: rawIPEnabled, Opener: openIP4Datagram, OptionCaps: xio.CapsIP4Datagram, Aliases: []string{"IP4-DGRAM"}, Kind: kindRaw, Role: dgram, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP6-DATAGRAM", Syntax: "IP6-DATAGRAM:<host>:<protocol>", Desc: "IPv6 raw IP datagram", Enabled: rawIPEnabled, Opener: openIP6Datagram, OptionCaps: xio.CapsIP6Datagram, Aliases: []string{"IP6-DGRAM"}, Kind: kindRaw, Role: dgram, Family: v6})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP-RECV", Syntax: "IP-RECV:<protocol>", Desc: "raw IP receive", Enabled: rawIPEnabled, Opener: openIPRecv, OptionCaps: xio.CapsIPDatagram, Kind: kindRaw, Role: recv, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP4-RECV", Syntax: "IP4-RECV:<protocol>", Desc: "IPv4 raw IP receive", Enabled: rawIPEnabled, Opener: openIP4Recv, OptionCaps: xio.CapsIP4Datagram, Kind: kindRaw, Role: recv, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP6-RECV", Syntax: "IP6-RECV:<protocol>", Desc: "IPv6 raw IP receive", Enabled: rawIPEnabled, Opener: openIP6Recv, OptionCaps: xio.CapsIP6Datagram, Kind: kindRaw, Role: recv, Family: v6})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP-RECVFROM", Syntax: "IP-RECVFROM:<protocol>", Desc: "raw IP recvfrom", Enabled: rawIPEnabled, Opener: openIPRecvfrom, OptionCaps: xio.CapsIPRecvfrom, Kind: kindRaw, Role: recvFrom, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP4-RECVFROM", Syntax: "IP4-RECVFROM:<protocol>", Desc: "IPv4 raw IP recvfrom", Enabled: rawIPEnabled, Opener: openIP4Recvfrom, OptionCaps: xio.CapsIP4Recvfrom, Kind: kindRaw, Role: recvFrom, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupRawIP, Name: "IP6-RECVFROM", Syntax: "IP6-RECVFROM:<protocol>", Desc: "IPv6 raw IP recvfrom", Enabled: rawIPEnabled, Opener: openIP6Recvfrom, OptionCaps: xio.CapsIP6Recvfrom, Kind: kindRaw, Role: recvFrom, Family: v6})
	...
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP", Syntax: "SCTP:<host>:<port>", Desc: "SCTP client", Enabled: sctpEnabled, Opener: openSCTPConnect, OptionCaps: xio.CapsSCTPConnect, Role: connect, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP-CONNECT", Syntax: "SCTP-CONNECT:<host>:<port>", Desc: "same as SCTP", Enabled: sctpEnabled, Opener: openSCTPConnect, OptionCaps: xio.CapsSCTPConnect, Role: connect, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP-LISTEN", Syntax: "SCTP-LISTEN:<port>", Desc: "SCTP server", Enabled: sctpEnabled, Opener: openSCTPListen, OptionCaps: xio.CapsSCTPListen, Role: listen, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP-L", Syntax: "SCTP-L:<port>", Desc: "same as SCTP-LISTEN", Enabled: sctpEnabled, Opener: openSCTPListen, OptionCaps: xio.CapsSCTPListen, Role: listen, Family: anyIP})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP4", Syntax: "SCTP4:<host>:<port>", Desc: "IPv4 SCTP client", Enabled: sctpEnabled, Opener: openSCTP4Connect, OptionCaps: xio.CapsSCTP4Connect, Role: connect, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP4-CONNECT", Syntax: "SCTP4-CONNECT:<host>:<port>", Desc: "same as SCTP4", Enabled: sctpEnabled, Opener: openSCTP4Connect, OptionCaps: xio.CapsSCTP4Connect, Role: connect, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP4-LISTEN", Syntax: "SCTP4-LISTEN:<port>", Desc: "IPv4 SCTP server", Enabled: sctpEnabled, Opener: openSCTP4Listen, OptionCaps: xio.CapsSCTP4Listen, Role: listen, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP4-L", Syntax: "SCTP4-L:<port>", Desc: "same as SCTP4-LISTEN", Enabled: sctpEnabled, Opener: openSCTP4Listen, OptionCaps: xio.CapsSCTP4Listen, Role: listen, Family: v4})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP6", Syntax: "SCTP6:<host>:<port>", Desc: "IPv6 SCTP client", Enabled: sctpEnabled, Opener: openSCTP6Connect, OptionCaps: xio.CapsSCTP6Connect, Role: connect, Family: v6})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP6-CONNECT", Syntax: "SCTP6-CONNECT:<host>:<port>", Desc: "same as SCTP6", Enabled: sctpEnabled, Opener: openSCTP6Connect, OptionCaps: xio.CapsSCTP6Connect, Role: connect, Family: v6})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP6-LISTEN", Syntax: "SCTP6-LISTEN:<port>", Desc: "IPv6 SCTP server", Enabled: sctpEnabled, Opener: openSCTP6Listen, OptionCaps: xio.CapsSCTP6Listen, Role: listen, Family: v6})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupSCTP, Name: "SCTP6-L", Syntax: "SCTP6-L:<port>", Desc: "same as SCTP6-LISTEN", Enabled: sctpEnabled, Opener: openSCTP6Listen, OptionCaps: xio.CapsSCTP6Listen, Role: listen, Family: v6})
	...
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupVSOCK, Name: "VSOCK", Syntax: "VSOCK:<cid>:<port>", Desc: "same as VSOCK-CONNECT", Enabled: vsockEnabled, Opener: openVSOCKConnect, OptionCaps: xio.CapsVSOCKConnect, Kind: kindVSOCK, Role: connect})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupVSOCK, Name: "VSOCK-CONNECT", Syntax: "VSOCK-CONNECT:<cid>:<port>", Desc: "VSOCK stream client", Enabled: vsockEnabled, Opener: openVSOCKConnect, OptionCaps: xio.CapsVSOCKConnect, Kind: kindVSOCK, Role: connect})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupVSOCK, Name: "VSOCK-LISTEN", Syntax: "VSOCK-LISTEN:<port>", Desc: "VSOCK stream server", Enabled: vsockEnabled, Opener: openVSOCKListen, OptionCaps: xio.CapsVSOCKListen, Kind: kindVSOCK, Role: listen})
	xio.RegisterAddress(xio.AddressDesc{Group: xio.GroupVSOCK, Name: "VSOCK-L", Syntax: "VSOCK-L:<port>", Desc: "same as VSOCK-LISTEN", Enabled: vsockEnabled, Opener: openVSOCKListen, OptionCaps: xio.CapsVSOCKListen, Kind: kindVSOCK, Role: listen})
}
