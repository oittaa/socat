...
func TestValidateAddressOptions(t *testing.T) {
	tests := []struct {
		...
		{name: "socket-listen-fork", spec: "SOCKET-LISTEN:2:0:x00,fork,reuseaddr,backlog=16"},
		...
		{name: "backlog-on-unix", spec: "UNIX-LISTEN:sock,backlog=10"},
		{name: "backlog-on-tls", spec: "TLS-LISTEN:1,backlog=10"},
		{name: "backlog-on-ws", spec: "WS-LISTEN:1,backlog=10"},
		{name: "backlog-on-wss", spec: "WSS-LISTEN:1,backlog=10"},
		{name: "backlog-on-udp-listen", spec: "UDP-LISTEN:1,backlog=10"},
