...
func TestValidateAddressOptions(t *testing.T) {
	tests := []struct {
		...
		{name: "tightsocklen-on-tcp", spec: "TCP:localhost:1,unix-tightsocklen", wantErr: "not supported"},
		{name: "tightsocklen-on-unix-listen", spec: "UNIX-LISTEN:sock,unix-tightsocklen", windowsErr: "not supported on this platform"},
		{name: "tightsocklen-zero-on-unix", spec: "UNIX-CONNECT:sock,tightsocklen=0", windowsErr: "not supported on this platform"},
		{name: "tightsocklen-garbage", spec: "UNIX-LISTEN:sock,tightsocklen=garbage", wantErr: "invalid"},
		{name: "unix-tightsocklen-garbage", spec: "UNIX-CONNECT:sock,unix-tightsocklen=no", wantErr: "invalid"},
		...
		{name: "backlog-on-inet-listen-alias", spec: "INET-LISTEN:1,backlog=10", windowsErr: "not supported on Windows"},
		...
		{name: "fork-on-socket-connect", spec: "SOCKET-CONNECT:2:0:x00,fork"},
		{name: "retry-on-socket-connect", spec: "SOCKET-CONNECT:2:0:x00,retry=2,interval=0.05,connect-timeout=0.3,forever"},
		...
		{name: "end-close", spec: "TCP:localhost:1,end-close"},
		{name: "end-close-zero", spec: "TCP:localhost:1,end-close=0"},
		{name: "end-close-one", spec: "TCP:localhost:1,end-close=1"},
		{name: "end-close-empty", spec: "TCP:localhost:1,end-close=", wantErr: "requires a value"},
		{name: "end-close-two", spec: "TCP:localhost:1,end-close=2", wantErr: "invalid"},
		{name: "end-close-garbage", spec: "TCP:localhost:1,end-close=garbage", wantErr: "invalid"},
		{name: "close-alias", spec: "TCP:localhost:1,close"},
		{name: "close-alias-zero", spec: "TCP:localhost:1,close=0"},
		{name: "close-alias-one", spec: "TCP:localhost:1,close=1"},
		{name: "close-alias-empty", spec: "TCP:localhost:1,close=", wantErr: "requires a value"},
		{name: "close-alias-two", spec: "TCP:localhost:1,close=2", wantErr: "invalid"},
		{name: "close-alias-garbage", spec: "TCP:localhost:1,close=garbage", wantErr: "invalid"},
		...
		{name: "vsock-listen-fork", spec: "VSOCK-LISTEN:9,fork,reuseaddr,backlog=16", windowsErr: "not supported on Windows"},
		...
		{name: "socket-connect-so-protocol", spec: "SOCKET-CONNECT:2:0:x00,so-protocol=6"},
		{name: "socket-connect-so-prototype", spec: "SOCKET-CONNECT:2:0:x00,so-prototype=6"},
		{name: "socket-connect-prototype", spec: "SOCKET-CONNECT:2:0:x00,prototype=6"},
		{name: "socket-connect-protocol", spec: "SOCKET-CONNECT:2:6:x00,protocol=17"},
		{name: "socket-listen-so-protocol", spec: "SOCKET-LISTEN:2:0:x00,so-protocol=6"},
		{name: "socket-listen-range", spec: "SOCKET-LISTEN:2:0:x00,range=127.0.0.1/32"},
		{name: "socket-listen-fork", spec: "SOCKET-LISTEN:2:0:x00,fork,reuseaddr,backlog=16", windowsErr: "not supported on Windows"},
		{name: "socket-datagram-protocol", spec: "SOCKET-DATAGRAM:2:2:0:x00,protocol=17"},
		{name: "socket-datagram-range", spec: "SOCKET-DATAGRAM:2:2:17:x00,range=127.0.0.1/32"},
		{name: "socket-recv-range", spec: "SOCKET-RECV:2:2:0:x00,range=127.0.0.1/32"},
		{name: "socket-recvfrom-fork", spec: "SOCKET-RECVFROM:2:2:0:x00,fork"},
		{name: "socket-recvfrom-range", spec: "SOCKET-RECVFROM:2:2:0:x00,range=127.0.0.1/32"},
		{name: "socket-sendto-range", spec: "SOCKET-SENDTO:2:2:17:x00,range=127.0.0.1/32", wantErr: "not supported"},
		...
		{name: "tcp-info-unknown", spec: "TCP:localhost:1,tcp-info", wantErr: "unknown option"},
		{name: "info-tcp-alias-unknown", spec: "TCP:localhost:1,info", wantErr: "unknown option"},
		{name: "tcp-md5sig-unknown", spec: "TCP:localhost:1,tcp-md5sig", wantErr: "unknown option"},
		{name: "md5sig-unknown", spec: "TCP:localhost:1,md5sig", wantErr: "unknown option"},
		{name: "chroot-unknown", spec: "TCP:localhost:1,chroot=/", wantErr: "unknown option"},
		{name: "setuid-unknown", spec: "TCP:localhost:1,setuid=65534", wantErr: "unknown option"},
		{name: "setgid-unknown", spec: "TCP:localhost:1,setgid=65534", wantErr: "unknown option"},
		{name: "substuser-unknown", spec: "TCP:localhost:1,substuser=65534", wantErr: "unknown option"},
		{name: "su-alias-unknown", spec: "TCP:localhost:1,su=65534", wantErr: "unknown option"},
		...
		{name: "hdrincl-on-ip4-sendto", spec: "IP4-SENDTO:127.0.0.1:255,ip-hdrincl", windowsErr: "not supported on this platform"},
		{name: "hdrincl-alias-on-ip4", spec: "IP4-SENDTO:127.0.0.1:255,hdrincl", windowsErr: "not supported on this platform"},
		{name: "iphdrincl-alias-on-ip4", spec: "IP4-SENDTO:127.0.0.1:255,iphdrincl", windowsErr: "not supported on this platform"},
		{name: "hdrincl-zero-on-ip4", spec: "IP4-SENDTO:127.0.0.1:255,ip-hdrincl=0", windowsErr: "not supported on this platform"},
		{name: "hdrincl-on-ip4-recv", spec: "IP4-RECV:255,ip-hdrincl", windowsErr: "not supported on this platform"},
		{name: "hdrincl-on-ip4-datagram", spec: "IP4-DATAGRAM:127.0.0.1:255,ip-hdrincl", windowsErr: "not supported on this platform"},
		{name: "hdrincl-on-tcp", spec: "TCP:localhost:1,ip-hdrincl", wantErr: "not supported"},
		{name: "hdrincl-on-udp", spec: "UDP:localhost:1,ip-hdrincl", wantErr: "not supported"},
		{name: "hdrincl-on-quic", spec: "QUIC:localhost:1,ip-hdrincl", wantErr: "not supported"},
		{name: "hdrincl-on-ip6", spec: "IP6-SENDTO:[::1]:255,ip-hdrincl", wantErr: "not supported on IPv6", windowsErr: "not supported on this platform"},
		{name: "hdrincl-on-file", spec: "OPEN:file,ip-hdrincl", wantErr: "not supported"},
		{name: "hdrincl-garbage", spec: "IP4-SENDTO:127.0.0.1:255,ip-hdrincl=true", wantErr: "invalid"},
		...
		{name: "backlog-on-tcp", spec: "TCP-LISTEN:1,backlog=10", windowsErr: "not supported on Windows"},
		{name: "backlog-on-unix", spec: "UNIX-LISTEN:sock,backlog=10", windowsErr: "not supported on Windows"},
		{name: "backlog-on-tls", spec: "TLS-LISTEN:1,backlog=10", windowsErr: "not supported on Windows"},
		{name: "backlog-on-ws", spec: "WS-LISTEN:1,backlog=10", windowsErr: "not supported on Windows"},
		{name: "backlog-on-wss", spec: "WSS-LISTEN:1,backlog=10", windowsErr: "not supported on Windows"},
		{name: "backlog-on-udp-listen", spec: "UDP-LISTEN:1,backlog=10", windowsErr: "not supported on Windows"},
		...
		{name: "backlog-on-socket", spec: "SOCKET-LISTEN:2:0:x00,backlog=10", windowsErr: "not supported on Windows"},
		...
		{name: "nopush-on-tcp", spec: "TCP:localhost:1,nopush"},
		{name: "noopt-on-tcp", spec: "TCP:localhost:1,noopt"},
		{name: "tcp-nopush-alias-on-tls", spec: "TLS:localhost:1,tcp-nopush"},
		...
		{name: "so-rcvlowat-on-tcp", spec: "TCP:localhost:1,so-rcvlowat=64"},
		{name: "rcvlowat-alias-on-udp", spec: "UDP:localhost:1,rcvlowat"},
		{name: "so-sndlowat-on-tcp", spec: "TCP:localhost:1,so-sndlowat=64"},
		{name: "sndlowat-alias-on-udp", spec: "UDP:localhost:1,sndlowat"},
		{name: "invalid-so-rcvlowat", spec: "TCP:localhost:1,so-rcvlowat=no", wantErr: "invalid"},
		{name: "invalid-sndlowat-alias", spec: "TCP:localhost:1,sndlowat=", wantErr: "requires a value"},
		...
		{name: "no-check-alias-on-tcp", spec: "TCP:localhost:1,no-check=1"},
		{name: "so-priority-on-file", spec: "OPEN:file,so-priority=6", wantErr: "not supported"},
		{name: "so-passcred-on-file", spec: "OPEN:file,passcred", wantErr: "not supported"},
		{name: "so-no-check-on-file", spec: "OPEN:file,nocheck", wantErr: "not supported"},
		{name: "so-detach-filter-on-tcp", spec: "TCP:localhost:1,so-detach-filter"},
		{name: "so-detach-filter-on-udp", spec: "UDP:localhost:1,detachfilter=1"},
		{name: "so-detach-filter-on-stdio", spec: "STDIO,detach-filter"},
		{name: "so-detach-filter-on-exec", spec: "EXEC:true,so-detach-filter=1"},
		{name: "so-detach-filter-on-file", spec: "OPEN:file,so-detach-filter", wantErr: "not supported"},
		{name: "invalid-so-detach-filter", spec: "TCP:localhost:1,so-detach-filter=no", wantErr: "invalid"},
		{name: "invalid-detach-filter-empty", spec: "TCP:localhost:1,detach-filter=", wantErr: "requires a value"},
		{name: "fiosetown-on-tcp", spec: "TCP:localhost:1,fiosetown"},
		{name: "siocspgrp-on-udp", spec: "UDP:localhost:1,siocspgrp=1"},
		{name: "fiosetown-on-stdio", spec: "STDIO,fiosetown=1"},
		{name: "siocspgrp-on-exec", spec: "EXEC:true,siocspgrp"},
		{name: "fiosetown-on-file", spec: "OPEN:file,fiosetown", wantErr: "not supported"},
		{name: "siocspgrp-on-file", spec: "OPEN:file,siocspgrp=1", wantErr: "not supported"},
		{name: "invalid-fiosetown", spec: "TCP:localhost:1,fiosetown=no", wantErr: "invalid"},
		{name: "invalid-siocspgrp", spec: "TCP:localhost:1,siocspgrp=", wantErr: "requires a value"},
		{name: "so-error-unknown", spec: "TCP:localhost:1,so-error", wantErr: "unknown option"},
		{name: "error-alias-unknown", spec: "TCP:localhost:1,error", wantErr: "unknown option"},
		{name: "so-acceptconn-unknown", spec: "TCP:localhost:1,so-acceptconn", wantErr: "unknown option"},
		{name: "so-peercred-unknown", spec: "TCP:localhost:1,so-peercred", wantErr: "unknown option"},
		{name: "so-attach-filter-unknown", spec: "TCP:localhost:1,so-attach-filter", wantErr: "unknown option"},
		{name: "attachfilter-unknown", spec: "TCP:localhost:1,attachfilter", wantErr: "unknown option"},
		{name: "so-security-authentication-unknown", spec: "TCP:localhost:1,so-security-authentication", wantErr: "unknown option"},
		{name: "securityencryptiontransport-unknown", spec: "TCP:localhost:1,securityencryptiontransport", wantErr: "unknown option"},
		{name: "so-rcvlowat-on-file", spec: "OPEN:file,so-rcvlowat=64", wantErr: "not supported"},
		{name: "so-sndlowat-on-file", spec: "OPEN:file,sndlowat=64", wantErr: "not supported"},
		{name: "tcp-cork-on-udp", spec: "UDP:localhost:1,tcp-cork", wantErr: "not supported"},
		{name: "nopush-on-udp", spec: "UDP:localhost:1,nopush", wantErr: "not supported"},
		{name: "noopt-on-udp", spec: "UDP:localhost:1,noopt", wantErr: "not supported"},
