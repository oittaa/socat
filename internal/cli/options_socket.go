...
func socketOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		{"Sockets", []helpOpt{
			...
			{name: "res-usevc", desc: "per-address DNS over TCP (RES_USEVC)", aliases: []string{"usevc"}, addressTypes: resolverAddressTypes(), implementationGroups: resolverImplementationGroups(), validate: validateOptionalBool},
