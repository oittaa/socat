...
func socketOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		{"Sockets", []helpOpt{
			...
			{name: "res-usevc", desc: "per-address DNS over TCP (RES_USEVC); =0 clears even if resolv.conf has use-vc", aliases: []string{"usevc"}, addressTypes: resolverAddressTypes(), implementationGroups: resolverImplementationGroups(), validate: validateOptionalBool},
