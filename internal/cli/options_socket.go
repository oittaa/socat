...
func socketOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		{"Sockets", []helpOpt{
			...
			{name: "ipv6-recvdstopts", desc: "IPV6_RECVDSTOPTS", aliases: []string{"recvdstopts"}, implementationGroups: xio.IPAncillaryImplementationGroups("ipv6-recvdstopts")},
			{name: "ipv6-recvhopopts", desc: "IPV6_RECVHOPOPTS", aliases: []string{"recvhopopts"}, implementationGroups: xio.IPAncillaryImplementationGroups("ipv6-recvhopopts")},
