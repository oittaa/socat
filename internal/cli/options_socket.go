...
func socketOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		{"Sockets", []helpOpt{
			...
			{name: "ip-recvdstaddr", desc: "IP_RECVDSTADDR (Darwin/BSD)", aliases: []string{"recvdstaddr", "iprecvdstaddr"}, implementationGroups: xio.IPAncillaryImplementationGroups("ip-recvdstaddr")},
			{name: "ip-recvif", desc: "IP_RECVIF (Darwin/BSD)", aliases: []string{"recvif"}, implementationGroups: xio.IPAncillaryImplementationGroups("ip-recvif")},
