...
func socketOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		{"Sockets", []helpOpt{
			...
			{name: "res-nsaddr", desc: "per-address DNS nameserver host[:port]", aliases: []string{"dns", "nameserver", "nsaddr"}, addressTypes: resolverAddressTypes(), implementationGroups: resolverImplementationGroups(), validate: validateResNSAddr},
