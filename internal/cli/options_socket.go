...
func socketOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		{"Sockets", []helpOpt{
			...
			{name: "ipv6-recvrthdr", desc: "IPV6_RECVRTHDR", aliases: []string{"recvrthdr"}, implementationGroups: xio.IPAncillaryImplementationGroups("ipv6-recvrthdr")},
			{name: "ipv6-recvpathmtu", desc: "IPV6_RECVPATHMTU", implementationGroups: xio.IPAncillaryImplementationGroups("ipv6-recvpathmtu")},
