...
func socketOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		{"Sockets", []helpOpt{
			...
			{name: "ip-multicast-loop", desc: "multicast loopback (IP_MULTICAST_LOOP)", aliases: []string{"multicast-loop", "mcloop", "ipmulticastloop", "multicastloop"}, validate: validateOptionalByte},
			...
			{name: "ipv6-multicast-loop", desc: "IPv6 multicast loopback (IPV6_MULTICAST_LOOP)", aliases: []string{"ipv6-mcloop", "mcloop6"}, validate: validateOptionalInteger(0)},
			...
			{name: "ip-freebind", desc: "IP_FREEBIND (Linux)", aliases: []string{"freebind", "ipfreebind"}, validate: validateOptionalInteger(0)},
			{name: "ip-transparent", desc: "IP_TRANSPARENT before bind (Linux)", aliases: []string{"transparent"}},
