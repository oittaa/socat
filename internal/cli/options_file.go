...
func fileOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		{"Files and UNIX", []helpOpt{
			...
			{name: "fs-append", desc: "set FS_APPEND_FL on the file (not O_APPEND)", aliases: []string{"ext2-append", "ext3-append"}},
			{name: "fs-compr", desc: "set FS_COMPR_FL on the file", aliases: []string{"compr", "ext2-compr", "ext3-compr"}},
			{name: "fs-dirsync", desc: "set FS_DIRSYNC_FL on the file", aliases: []string{"dirsync", "ext2-dirsync", "ext3-dirsync"}},
			{name: "fs-immutable", desc: "set FS_IMMUTABLE_FL on the file", aliases: []string{"immutable", "ext2-immutable", "ext3-immutable"}},
			{name: "fs-journal-data", desc: "set FS_JOURNAL_DATA_FL on the file", aliases: []string{"journal", "journal-data", "ext2-journal-data", "ext3-journal-data"}},
			{name: "fs-noatime", desc: "set FS_NOATIME_FL on the file", aliases: []string{"ext2-noatime", "ext3-noatime"}},
			{name: "fs-nodump", desc: "set FS_NODUMP_FL on the file", aliases: []string{"nodump", "ext2-nodump", "ext3-nodump"}},
			{name: "fs-notail", desc: "set FS_NOTAIL_FL on the file", aliases: []string{"notail", "ext2-notail", "ext3-notail"}},
			{name: "fs-secrm", desc: "set FS_SECRM_FL on the file", aliases: []string{"secrm", "ext2-secrm", "ext3-secrm"}},
			{name: "fs-sync", desc: "set FS_SYNC_FL on the file (not O_SYNC)", aliases: []string{"ext2-sync", "ext3-sync"}},
			{name: "fs-topdir", desc: "set FS_TOPDIR_FL on the file", aliases: []string{"topdir", "ext2-topdir", "ext3-topdir"}},
			{name: "fs-unrm", desc: "set FS_UNRM_FL on the file", aliases: []string{"unrm", "ext2-unrm", "ext3-unrm"}},
