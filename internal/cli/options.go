...
func helpOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		...
		{"Files and UNIX", []helpOpt{
			...
			{name: "perm-early", desc: "chmod an existing name before open", validate: validateOctal(0o7777)},
			...
			{name: "user-early", desc: "chown an existing name before open", aliases: []string{"uid-e"}},
			{name: "group-early", desc: "chgrp an existing name before open", aliases: []string{"gid-e"}},
