...
func tlsOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		...
		{"Datagram TLS", []helpOpt{
			...
			{name: "dtls-unfragmented-probes", desc: "confirm and discover path MTU on a dedicated socket (default on with migration)", addressTypes: dtlsAddressTypes(), validate: validateOptionalBool},
		}},
		{"WebSocket", []helpOpt{
