...
var dynamicallyReadOptions = map[string]string{
	...
	"iff-notrailers": "tunopen/tun_linux.go", "iff-master": "tunopen/tun_linux.go",
	"iff-slave": "tunopen/tun_linux.go", "iff-portsel": "tunopen/tun_linux.go",
	"iff-automedia": "tunopen/tun_linux.go",
	...
	"notrailers": "tunopen/tun_linux.go", "master": "tunopen/tun_linux.go",
	"slave": "tunopen/tun_linux.go", "portsel": "tunopen/tun_linux.go",
	"automedia": "tunopen/tun_linux.go",
	...
	"recvdstopts": "xio/ancillary.go", "recvhopopts": "xio/ancillary.go",
	"recvrthdr": "xio/ancillary.go",
	...
	"ipv6-recvdstopts": "xio/ancillary.go", "ipv6-recvhopopts": "xio/ancillary.go",
	"ipv6-recvrthdr": "xio/ancillary.go", "ipv6-recvpathmtu": "xio/ancillary.go",
	"ip-retopts":     "xio/ancillary.go",
	"ip-recvdstaddr": "xio/ancillary.go", "ip-recvif": "xio/ancillary.go",
	"ip-recverr": "xio/recverr_linux.go", "recverr": "xio/recverr_linux.go", "iprecverr": "xio/recverr_linux.go",
	...
	// Generic ioctl family: PH_FD applyopts walk (not OptionNamed).
	"ioctl":        "xio/fdopts_lifecycle_unix.go applyFDPhaseLifecycleOptions",
	"ioctl-void":   "xio/fdopts_lifecycle_unix.go applyFDPhaseLifecycleOptions",
	"ioctl-int":    "xio/fdopts_lifecycle_unix.go applyFDPhaseLifecycleOptions",
	...
	"binary":       "xio/descriptor_mode_windows.go applyDescriptorMode", "bin": "xio/descriptor_mode_windows.go applyDescriptorMode", "o-binary": "xio/descriptor_mode_windows.go applyDescriptorMode",
	"text": "xio/descriptor_mode_windows.go applyDescriptorMode", "o-text": "xio/descriptor_mode_windows.go applyDescriptorMode",
	"noinherit": "xio/fdopts_lifecycle_windows.go applyWindowsOpen", "o-noinherit": "xio/fdopts_lifecycle_windows.go applyWindowsOpen",
