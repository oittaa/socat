...
var dynamicallyReadOptions = map[string]string{
	...
	"perm-late": "xio/fdopts_lifecycle.go", "mode-late": "xio/fdopts_lifecycle.go",
	"user-late": "xio/fdopts_lifecycle.go", "uid-l": "xio/fdopts_lifecycle.go", "owner-late": "xio/fdopts_lifecycle.go",
