...
func processOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		{"EXEC, SYSTEM, SHELL", []helpOpt{
			...
			{name: "dash", desc: "prefix EXEC argv[0] with '-' (login shell); unused on SYSTEM/SHELL", aliases: []string{"login"}},
			{name: "setpgid", desc: "set child process group; omitted/0/1 start a new group", aliases: []string{"pgid"}, validate: validateOptionalSignedInteger},
			{name: "sighup", desc: "pass SIGHUP to the EXEC/SYSTEM/SHELL child instead of exiting", validate: validateNoValue},
			{name: "sigint", desc: "pass SIGINT to the EXEC/SYSTEM/SHELL child instead of exiting", validate: validateNoValue},
			{name: "sigquit", desc: "pass SIGQUIT to the EXEC/SYSTEM/SHELL child instead of exiting", validate: validateNoValue},
		...
		{"PTY and TERMIOS", []helpOpt{
			...
			{name: "raw", desc: "obsolete raw termios mode"},
