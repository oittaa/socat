...
func helpOptionGroups() []helpOptGroup {
	return []helpOptGroup{
		...
		{"Files and UNIX", []helpOpt{
			...
			{"setlk", "nonblocking whole-file write lock", []string{"f-setlk-wr"}},
			{"setlkw", "blocking whole-file write lock", []string{"f-setlkw-wr"}},
			{"setlk-rd", "nonblocking whole-file read lock", []string{"f-setlk-rd"}},
			{"setlkw-rd", "blocking whole-file read lock", []string{"f-setlkw-rd"}},
		...
		{"TLS, WSS, and QUIC", []helpOpt{
			...
			{"ciphers", "TLS 1.2 cipher suite list", []string{"cipher", "openssl-cipherlist"}},
