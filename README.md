...
| UDPLITE | `UDPLITE4:host:port`, `UDPLITE4-LISTEN:port`, … | Linux and FreeBSD UDP-Lite (`IPPROTO_UDPLITE`); `udplite-send-cscov` / `udplite-recv-cscov` |
